...
D_CONSTANCIA_NUEVAS = ['C_2d2', 'C_3d3', 'I_1d2', 'I_1d3', 'I_1d4','I_1d5', 'I_1d6', 'I_2d2',
                       'I_2d3', 'I_2d4', 'I_2d5', 'I_2d6', 'I_3d3', 'I_3d4', 'I_3d5', 'I_3d6',
                       'I_4d4', 'I_4d5', 'I_4d6', 'I_5d5', 'I_5d6', 'I_6d6', 'Est']
...
O_LINK_INVITACION_SMS_FICHA = 'LINKINVITACIONSMSFICHA'
O_LINK_INVITACION_SMS_LANDING = 'LINKINVITACIONSMSLANDING'
O_LINK_INVITACION_EMAIL_FICHA = 'LINKINVITACIONEMAILFICHA'
O_LINK_INVITACION_EMAIL_LANDING = 'LINKINVITACIONEMAILLANDING'
...
O_FIELDS_USU_CAMP = [ O_ANIO_CAMPANA_EXPOSICION, O_ANIO_CAMPANA_INGRESO, O_ANIO_CAMPANA_PROCESO, O_CUC_LANZAMIENTO,
                      ...
                      O_IDORIGIN, O_IP_UNICO_PU5C, O_ID_CAMPANA_CONSULTORA, O_LINK_INVITACION_EMAIL_FICHA,
                      O_LINK_INVITACION_EMAIL_LANDING, O_LINK_INVITACION_SMS_FICHA, O_LINK_INVITACION_SMS_LANDING,
...
O_YY1_ANTIGUEDAD_MPS = 'YY1_ANTIGUEDAD_MPS'
O_YY1_COD_SECCION_MPS = 'YY1_COD_SECCION_MPS'
O_YY1_FLAG_CONSTANCIA_MPS = 'YY1_FLAG_CONSTANCIA_MPS'
...
O_FIELDS_CONTACT = [O_ID_ORIGIN, O_ID, O_NAME_FIRST, O_NAME_LAST, O_TITLE_FT,
                    ...
                    O_SMTP_ADDR_2, O_SMTP_ADDR_3, O_YY1_ANTIGUEDAD_MPS, O_YY1_COD_SECCION_MPS,
                    O_YY1_FLAG_CONSTANCIA_MPS]
